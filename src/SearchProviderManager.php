...
final class SearchProviderManager
{
    ...
    private function execute(string $method, SearchQueryData $query): SearchProviderExecutionResult
    {
        $definitions = $this->resolveDefinitions();
        $attempts = [];
        $fallbackUsed = false;
        $emptyResult = new SearchResultCollection();
    ...
    private function resolveProvider(SearchProviderDefinition $definition): SearchProviderInterface
    {
